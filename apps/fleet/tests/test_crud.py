"""Writing Brand rows: who may, what happens, and what a delete means.

Same shape as apps/company/tests/test_crud.py, scoped to Brand -- reusing the
generic save/delete views from apps.company.writes directly, so these tests
also cover that reuse holds for a second app.
"""
